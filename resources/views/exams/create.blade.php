...
@section('content')
    <div class="container p-6 mx-auto" x-data="{ questionsAdded: false, showError: false }" @questionsAdded="questionsAdded = true">
        <!-- Page Title -->
        ...
        <div class="p-6 bg-white rounded-lg shadow-md">
            <form action="{{ route('exams.store') }}" method="POST">
                ...
                <div x-show="showError" class="mt-2 text-sm text-red-600">
                    <strong>Please add questions to the exam.</strong>
                </div>
                ...
                <button type="submit"
                    ...
                    :disabled="!questionsAdded" x-bind:class="!questionsAdded ? 'opacity-50 cursor-not-allowed' : ''"
                    x-on:click="if (!questionsAdded) { showError = true; } else { showError = false; }">
                    Create Exam
                </button>
            </form>
        </div>
    ...
    <script>
        ...
        document.getElementById('addQuestionBtn').addEventListener('click', function() {
            ...
            // Dispatch a custom event to notify Alpine.js that questions were added
            this.parentElement.parentElement.dispatchEvent(new CustomEvent('questionsAdded'));
